...
'''
    ...
    def test_profile_ui_and_package_order(self):
        ...
        self.assertEqual(profile["packages"], ["{{NPM:@narumitw/pi-caffeinate}}", "{{NPM:pi-btw}}", "{{NPM:pi-ask-user}}", "{{PLUGIN_PI_LENS}}", "{{NPM:pi-web-access}}", "{{NPM:pi-cursor-sdk}}", "{{PLUGIN_PI_SUBAGENTS}}", "{{PLUGIN_RPIV_TODO}}"])
